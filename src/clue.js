...
function revealMystery(envelope) {
    ...
    var message = firstName + ' ' + lastName + ' killed Mr. Boddy using the ' + weapon + ' in the ' + room + '!';
    return message;
}

// Choose a mystery
var envelope = pickMystery();

// Reveal the mystery and get the final message
var finalMessage = revealMystery(envelope);

// Display the final message in the console
